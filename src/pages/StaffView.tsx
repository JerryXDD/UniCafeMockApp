...
export default function StaffView({ onSwitchRole }: StaffViewProps) {
  ...
  return (
    <div className="max-w-2xl mx-auto pb-24">
      {/* Header */}
      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-5 rounded-b-3xl shadow-md mb-4">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-xl font-bold">👨‍🍳 Staff Dashboard</h1>
            <p className="text-purple-100 text-sm">Campus Cafeteria Management</p>
          </div>
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-1 text-xs text-emerald-100 bg-white/20 px-2 py-1 rounded-full">
      ...
      {page === 'dashboard' && (
        <div>
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-200 border-l-4 border-l-yellow-400">
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-200 border-l-4 border-l-blue-400">
              <div className="flex items-center gap-2 mb-1">
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-200 border-l-4 border-l-emerald-400">
              <div className="flex items-center gap-2 mb-1">
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-200 border-l-4 border-l-purple-400">
              <div className="flex items-center gap-2 mb-1">
                  ...
                  <div className="flex gap-2">
                    ...
                    {order.status === 'preparing' && (
                      <button
                        ...
                        className="flex-1 bg-emerald-500 text-white py-2 rounded-xl text-sm font-medium hover:bg-emerald-600 transition-colors"
                      >
                        Mark Ready
                      </button>
                    )}
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              ...
              className="bg-gradient-to-r from-purple-500 to-indigo-500 text-white px-4 py-2 rounded-xl text-sm font-medium hover:from-purple-600 hover:to-indigo-600 flex items-center gap-1 shadow-sm"
            >
          ...
          {/* Add Item Form */}
          {showAddForm && (
            <div className="bg-white rounded-2xl p-4 shadow-sm mb-4 border border-purple-200">
              <h3 className="font-semibold text-gray-700 mb-3">New Menu Item</h3>
              {menuError && (
                <div className="bg-red-50 border border-red-200 text-red-600 text-sm rounded-xl px-4 py-3 flex items-center gap-2 mb-3">
              ...
              <div className="space-y-3">
                <input
                  ...
                  className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-400"
                />
                <input
                  type="text"
                ...
                <div className="grid grid-cols-3 gap-2">
                  <input
                    ...
                    className="bg-gray-50 border border-gray-200 rounded-xl px-4 py-2 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-400"
                  />
                  <select
                    value={newItem.category}
                    onChange={e => setNewItem({...newItem, category: e.target.value as MenuItem['category']})}
                    className="bg-gray-50 border border-gray-200 rounded-xl px-3 py-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-400"
                  >
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-purple-500 to-indigo-500 text-white py-2 rounded-xl font-medium hover:from-purple-600 hover:to-indigo-600 transition-all shadow-sm"
                >
                  Add to Menu
                </button>
              </div>
          ...
          <div className="space-y-2">
            {menu.map(item => (
              <div key={item.id} className={`bg-white rounded-xl p-3 shadow-sm border border-gray-200 flex items-center gap-3 ${!item.available ? 'opacity-60' : ''}`}>
